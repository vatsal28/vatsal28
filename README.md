...
**Full tour with demos: [vatsal28.github.io](https://vatsal28.github.io)**
...
### Life OS tools
Local-first apps my family and agents use daily: a shared household PWA (shopping, meals, reminders), a content pipeline tracker, and a PKMS built on plain Markdown + Obsidian that an agent keeps organized.
...
```
vatsal@homelab:~$ uptime
agents online · apps shipped · nothing in the cloud that doesn't need to be
```
